...
<title>Fee Receipt {{ $application['receipt_no'] ?? $application['application_no'] }} · C-Net</title>
<style>
...
<header class="head"><div class="identity"><img src="{{ asset('images/cnet-logo.webp') }}" alt="C-Net"><div><h1>C-Net Computer Education</h1><p>Education · Skill Development · Career</p></div></div><div class="receipt-no"><small>FEE RECEIPT</small><b>{{ $application['receipt_no'] ?? 'PAYMENT PENDING' }}</b></div></header>
<div class="body">
