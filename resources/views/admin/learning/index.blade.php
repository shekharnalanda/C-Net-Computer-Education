...
<form method="post" action="{{ route('admin.learning.store') }}">@csrf
<div class="form-grid">
...
<label class="learning-wide">Resource URL<input type="url" name="link_url" value="{{ old('link_url') }}" maxlength="1000" placeholder="https://drive.google.com/..." required></label>
