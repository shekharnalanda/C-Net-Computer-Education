...
<header class="site-header"><a class="brand" href="#home"><img class="brand-logo" src="{{ asset('images/cnet-logo.webp') }}" alt="C-Net logo"><span><strong>C-Net</strong><small>Computer Education</small></span></a><button class="mobile-menu-toggle" id="mobileMenuToggle" type="button" aria-expanded="false" aria-controls="siteNavigation" aria-label="Open navigation"><span></span><span></span><span></span></button><nav id="siteNavigation"><a href="#home">Home</a><a href="#courses">Courses</a><a href="{{ route('admission.create') }}">Admission</a><a href="#jobs">Job Search</a><a href="{{ route('certificates.verify') }}">Verify Certificate</a><a href="{{ route('student.login') }}">Student Login</a><a href="#enquiry">Enquiry</a><a class="admin-nav-link" href="{{ route('admin.login') }}">Admin Login</a></nav></header>
