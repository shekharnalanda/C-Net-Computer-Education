<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="description" content="C-Net Computer Education — practical bilingual computer courses, skill development and career support in Bihar Sharif, Nalanda."><title>C-Net Computer Education</title>
<link rel="manifest" href="{{ asset('manifest.webmanifest') }}">
<meta name="theme-color" content="#07172d">
<link rel="apple-touch-icon" href="{{ asset('images/app-icon-192.png') }}">
<link rel="canonical" href="https://cnetcomputer.mciedu.com/">
<meta property="og:type" content="website">
<meta property="og:title" content="C-Net Computer Education">
<meta property="og:description" content="C-Net Computer Education — practical bilingual computer courses, skill development and career support in Bihar Sharif, Nalanda.">
<meta property="og:url" content="https://cnetcomputer.mciedu.com/">
<meta property="og:image" content="https://cnetcomputer.mciedu.com/images/cnet-logo.webp">
<meta property="og:site_name" content="C-Net Computer Education">
...
@if(count($notices))
<section class="section public-notices" id="notices"><div class="heading split"><div><span class="kicker">Latest Notices · नवीन सूचना</span><h2>Stay informed.<br><em>आगे बढ़ते रहें।</em></h2></div><p>Admissions, course updates, events and important announcements from C-Net.</p></div>
...
@endif
@if(count($gallery))
<section class="section public-gallery" id="gallery"><div class="heading split"><div><span class="kicker">C-Net Gallery · हमारी गतिविधियाँ</span><h2>Learning in action.<br><em>देखिए हमारा परिसर।</em></h2></div><p>Computer lab, classroom activities and student learning moments from C-Net.</p></div>
...
@endphp
<script>window.CNET_COURSES = @json($cnetCourses);</script><script src="{{ asset('js/navigation.js') }}"></script><script src="{{ asset('js/site.js') }}"></script><script src="{{ asset('js/app-install.js') }}"></script></body></html>
