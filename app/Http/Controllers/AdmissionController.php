...
class AdmissionController extends Controller
{
    ...
    public function store(Request $request, CentralSyncService $centralSync)
    {
        ...
        if ($request->hasFile('photo')) {
            ...
            $photoName = 'cnet-student-'.now()->format('YmdHis').'-'.strtolower(\Illuminate\Support\Str::random(8)).'.'.$photo->getClientOriginalExtension();
        ...
        $centralSync->admission([
            ...
            'source_reference_id' => 'cnet-computer-admission-'.$application['application_no'],
            'source_site' => config('app.url', 'https://cnetcomputer.mciedu.com'),
