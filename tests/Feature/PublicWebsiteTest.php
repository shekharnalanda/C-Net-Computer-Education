...
class PublicWebsiteTest extends TestCase
{
    ...
    {
        Course::create(['code'=>'DCA','title'=>'Diploma in Computer Applications','duration'=>'6 Months','level'=>'Foundation','summary'=>'Office skills','is_active'=>true]);
        $this->get('/')->assertOk()->assertSee('C-Net Computer Education')->assertSee('Diploma in Computer Applications', false);
    }
